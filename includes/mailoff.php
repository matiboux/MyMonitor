...
// message
$smtp->smtp_mail($donnees['user'], 'MyMonitor - Hors Ligne', 'Bonjour,
...
$sms='http://hexicans.eu/api/index.php?tel=0'.$donnees['phone'].'&key='.$donnees['apikey'].'&msg='.urlencode('ALERTE MyMonitor - Le serveur '.$donnees['IP'].' ('.$donnees['nom'].') semble etre hors ligne !').'';
